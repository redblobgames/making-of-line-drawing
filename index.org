...
** TODO Page should be accumulative

Each directory should include everything for all the previous directories too.

Each directory's index.html should include /all/ the diagrams, and then the main page can go in and hide all but the one we want to show. Tricky!
...
The tutorial is about drawing lines on a square grid, so I need to draw a grid and also draw lines. I'll draw a grid with Javascript, using the [[https://d3js.org/][d3.js library]]:

{ MOVE d3.js to top }

#+begin_export html
<iframe src="2/" width="600" height="250"/>
#+end_export
...
#+begin_export html
<iframe src="3/" width="600" height="250"/>
#+end_export
...
#+begin_export html
<iframe src="5/" width="600" height="250"/>
#+end_export
...
#+begin_export html
<iframe src="6/" width="600" height="250"/>
#+end_export
...
#+begin_export html
<iframe src="7/" width="600" height="150"/>
#+end_export
...
#+include: "8/line-drawing.js" src js :lines "8-19"

#+begin_export html
<iframe src="8/" width="600" height="300"/>
#+end_export

I'm starting to organize things in terms of layers, which have the /creation/ code and the /update/ code:

#+include: "8/line-drawing.js" src js :lines "67-81"
#+include: "8/line-drawing.js" src js :lines "115-127"
...
#+include: "9/line-drawing.js" src js :lines "19-35"
...
#+include: "9/line-drawing.js" src js :lines "51-66"

I can now assemble a diagram by calling the =addXYZ()= functions:

#+include: "9/line-drawing.js" src js :lines "179-"
...
#+include: "10/line-drawing.js" src js :lines "17-26"
...
#+include: "10/line-drawing.js" src js :lines "114-135"
...
#+include: "10/line-drawing.js" src js :lines "136-157"
...
#+begin_export html
<iframe src="11/" width="600" height="300"/>
#+end_export
...
#+begin_export html
<iframe src="12/" width="600" height="300"/>
#+end_export
