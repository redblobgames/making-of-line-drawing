...
#+begin_comment
On iOS, the iframe takes up the full height instead of honoring the height= attribute. Workaround? https://salomvary.github.io/iframe-resize-ios-safari.html
#+end_comment

#+begin_export html
<!-- 750 == 600 / 0.8 -->
<iframe id="iframe" src="/grids/line-drawing.html#interpolation" width="750" height="300" style="height:300px;transform:scale(0.75);transform-origin:left top;overflow-y:scroll"/>
#+end_export
...
{have another page with the final page}
